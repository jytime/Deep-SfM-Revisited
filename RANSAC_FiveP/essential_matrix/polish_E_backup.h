...
__host__ void polish_E_robust_parametric (Ematrix E, const double (*pin)[3], const double (*qin)[3], const int n, const double delta, const double alpha, const int MaxReps);
